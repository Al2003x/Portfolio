import preloadImages from "./module/preloadImages.js";
import burger from "./module/burgerMenu.js";
import scrollUp from "./module/scrollUp.js";
import changeGallery from "./module/gallery.js";
import changeLanguage from "./module/changeLang.js";
import changeMode from "./module/changeMode.js";
import openModalMessage from "./module/modalMessage.js";
import videoPlayer from "./module/videoPlayer.js";

changeLanguage();
changeMode();
preloadImages(['winter', 'spring', 'summer', 'autumn']);
burger();
scrollUp();
changeGallery();
openModalMessage();
...
console.log(`
► Самооценка за задание: 70 баллов
...
6. Кнопка Play/Pause в центре видео +10, а именно:
...
7. Очень высокое качество оформления приложения и/или дополнительный не предусмотренный в задании функционал, улучшающий качество приложения +10, а именно:
- внешний вид плеера соответсвует всему макету, соблюдены цвета, размеры perfect pixel
- в панель навигации добавлен доп. функционал: кнопка стоп, тайминг, кнопка full screen video
- при завершении видео осуществляется перемотка в начало
`);